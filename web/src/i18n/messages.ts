...
const en = {
  ...
  people: {
    title: 'People',
    roleFaculty: 'Faculty',
    rolePastFaculty: 'Past Faculty',
    roleResearchers: 'Researchers',
    rolePastResearchers: 'Past Researchers',
    rolePostdoc: 'Current PostDoctoral Researchers',
    rolePastPostdoc: 'Past PostDoctoral Researchers',
    rolePhd: 'Current PhD Students',
    rolePastPhd: 'Past PhD Students',
    roleMsc: 'Current MSc Students',
    rolePastMsc: 'Past MSc Students',
...
const pt: Dictionary = {
  ...
  people: {
    ...
    rolePastFaculty: 'Antigos Docentes',
    roleResearchers: 'Investigadores',
    rolePastResearchers: 'Antigos Investigadores',
    rolePostdoc: 'Investigadores de Pós-Doutoramento Atuais',
    rolePastPostdoc: 'Antigos Investigadores de Pós-Doutoramento',
    rolePhd: 'Doutorandos Atuais',
    rolePastPhd: 'Antigos Doutorandos',
    roleMsc: 'Mestrandos Atuais',
    rolePastMsc: 'Antigos Mestrandos',
